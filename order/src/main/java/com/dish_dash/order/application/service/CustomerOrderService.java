...
public class CustomerOrderService {
    ...
    @Transactional
    public OrderDto createOrder(long customerId, long restaurantOwnerId, List<OrderItemCreateDto> orderItemsDto) {
        ...
        List<OrderItem> orderItems = orderItemsDto.stream()
                .map(dto -> {
                    ...
                    orderItem.setPrice(new Price(itemTotalPrice, food.getPrice().getUnit()));
        ...
        Order order = Order.builder()
                ...
                .totalPrice(new Price(totalPrice.get(), orderItems.get(0).getPrice().getUnit()))
                .build();
    ...
    public OrderDto modifyOrder(long orderId, List<OrderItemCreateDto> orderItemsDto) {
        ...
        if (orderOptional.isPresent()) {
            ...
            order.setOrderItems(orderItems);
            order.setTotalPrice(new Price(totalPrice.get(), orderItems.get(0).getPrice().getUnit()));
